...
class StorageServiceListSnapshotsResponse(_message.Message):
    ...
    snapshots: _containers.RepeatedCompositeFieldContainer[_volume_pb2.Snapshot]
    def __init__(self, snapshots: _Optional[_Iterable[_Union[_volume_pb2.Snapshot, _Mapping]]] = ...) -> None: ...
