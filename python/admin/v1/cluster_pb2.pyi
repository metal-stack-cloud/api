...
class ClusterServiceCredentialsRequest(_message.Message):
    ...
    def __init__(self, uuid: _Optional[str] = ..., with_vpn: bool = ..., with_ssh: bool = ..., expiration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...

class ClusterServiceOperateRequest(_message.Message):
    __slots__ = ("uuid", "operate")
    UUID_FIELD_NUMBER: _ClassVar[int]
    OPERATE_FIELD_NUMBER: _ClassVar[int]
    uuid: str
    operate: Operate
    def __init__(self, uuid: _Optional[str] = ..., operate: _Optional[_Union[Operate, str]] = ...) -> None: ...
...
class ClusterServiceOperateResponse(_message.Message):
    ...
    CLUSTER_FIELD_NUMBER: _ClassVar[int]
    cluster: _cluster_pb2.Cluster
    def __init__(self, cluster: _Optional[_Union[_cluster_pb2.Cluster, _Mapping]] = ...) -> None: ...
