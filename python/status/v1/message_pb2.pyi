...
class MessageServiceListRequest(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class MessageServiceListResponse(_message.Message):
...
class Message(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., text: _Optional[str] = ..., kind: _Optional[_Union[MessageKind, str]] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., replies: _Optional[_Iterable[_Union[ReplyMessage, _Mapping]]] = ...) -> None: ...
...
class ReplyMessage(_message.Message):
    ...
    kind: MessageKind
    timestamp: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[str] = ..., text: _Optional[str] = ..., kind: _Optional[_Union[MessageKind, str]] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
