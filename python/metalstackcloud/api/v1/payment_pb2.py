...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['login']._loaded_options = None
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['login']._serialized_options = b'\272H\007r\005\020\002\030\200\001'
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['name']._serialized_options = b'\272H\003\310\001\001'
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['payment_method_id']._loaded_options = None
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['payment_method_id']._serialized_options = b'\272H\026r\024\020\0032\020pm_[a-zA-Z0-9]*$'
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['email']._loaded_options = None
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['email']._serialized_options = b'\272H\004r\002`\001'
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['vat']._loaded_options = None
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['vat']._serialized_options = b'\272H\003\310\001\001'
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['phone_number']._loaded_options = None
  _globals['_PAYMENTSERVICECREATEREQUEST'].fields_by_name['phone_number']._serialized_options = b'\272H\004r\002\020\001'
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['login']._loaded_options = None
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['login']._serialized_options = b'\272H\007r\005\020\002\030\200\001'
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['name']._serialized_options = b'\272H\004r\002\020\001'
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['payment_method_id']._loaded_options = None
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['payment_method_id']._serialized_options = b'\272H\026r\024\020\0032\020pm_[a-zA-Z0-9]*$'
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['email']._loaded_options = None
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['email']._serialized_options = b'\272H\004r\002`\001'
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['vat']._loaded_options = None
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['vat']._serialized_options = b'\272H\004r\002\020\001'
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['phone_number']._loaded_options = None
  _globals['_PAYMENTSERVICEUPDATEREQUEST'].fields_by_name['phone_number']._serialized_options = b'\272H\004r\002\020\001'
  _globals['_PAYMENTSERVICEGETREQUEST'].fields_by_name['login']._loaded_options = None
  _globals['_PAYMENTSERVICEGETREQUEST'].fields_by_name['login']._serialized_options = b'\272H\007r\005\020\002\030\200\001'
  ...
  _globals['_PAYMENTSERVICEDELETEREQUEST'].fields_by_name['login']._loaded_options = None
  _globals['_PAYMENTSERVICEDELETEREQUEST'].fields_by_name['login']._serialized_options = b'\272H\007r\005\020\002\030\200\001'
  ...
  _globals['_PAYMENTSERVICEHASCHARGEABLERESOURCESREQUEST'].fields_by_name['login']._loaded_options = None
  _globals['_PAYMENTSERVICEHASCHARGEABLERESOURCESREQUEST'].fields_by_name['login']._serialized_options = b'\272H\007r\005\020\002\030\200\001'
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONDISCOUNTSREQUEST'].fields_by_name['login']._loaded_options = None
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONDISCOUNTSREQUEST'].fields_by_name['login']._serialized_options = b'\272H\007r\005\020\002\030\200\001'
  _globals['_PAYMENTSERVICE'].methods_by_name['Create']._loaded_options = None
  _globals['_PAYMENTSERVICE'].methods_by_name['Create']._serialized_options = b'\302\363\030\001\001'
  _globals['_PAYMENTSERVICE'].methods_by_name['Update']._loaded_options = None
  _globals['_PAYMENTSERVICE'].methods_by_name['Update']._serialized_options = b'\302\363\030\001\001'
  _globals['_PAYMENTSERVICE'].methods_by_name['Delete']._loaded_options = None
  _globals['_PAYMENTSERVICE'].methods_by_name['Delete']._serialized_options = b'\302\363\030\001\001'
  _globals['_PAYMENTSERVICE'].methods_by_name['Get']._loaded_options = None
  _globals['_PAYMENTSERVICE'].methods_by_name['Get']._serialized_options = b'\302\363\030\001\001\350\363\030\002'
  ...
  _globals['_PAYMENTSERVICE'].methods_by_name['GetSubscriptionDiscounts']._loaded_options = None
  _globals['_PAYMENTSERVICE'].methods_by_name['GetSubscriptionDiscounts']._serialized_options = b'\302\363\030\001\001\350\363\030\002'
  _globals['_PRODUCTTYPE']._serialized_start=4218
  _globals['_PRODUCTTYPE']._serialized_end=4368
  _globals['_USAGETYPE']._serialized_start=4370
  _globals['_USAGETYPE']._serialized_end=4458
  _globals['_PRODUCTTIER']._serialized_start=4460
  _globals['_PRODUCTTIER']._serialized_end=4550
  _globals['_PAYMENTCUSTOMER']._serialized_start=116
  _globals['_PAYMENTCUSTOMER']._serialized_end=717
  _globals['_CARD']._serialized_start=720
  _globals['_CARD']._serialized_end=853
  _globals['_PRICE']._serialized_start=856
  _globals['_PRICE']._serialized_end=1163
  _globals['_ADDRESS']._serialized_start=1166
  _globals['_ADDRESS']._serialized_end=1320
  _globals['_SUBSCRIPTIONUSAGEITEM']._serialized_start=1323
  _globals['_SUBSCRIPTIONUSAGEITEM']._serialized_end=1693
  _globals['_DISCOUNT']._serialized_start=1696
  _globals['_DISCOUNT']._serialized_end=1882
  _globals['_INVOICE']._serialized_start=1885
  _globals['_INVOICE']._serialized_end=2074
  _globals['_PAYMENTSERVICECREATEREQUEST']._serialized_start=2077
  _globals['_PAYMENTSERVICECREATEREQUEST']._serialized_end=2405
  _globals['_PAYMENTSERVICECREATERESPONSE']._serialized_start=2407
  _globals['_PAYMENTSERVICECREATERESPONSE']._serialized_end=2490
  _globals['_PAYMENTSERVICEUPDATEREQUEST']._serialized_start=2493
  _globals['_PAYMENTSERVICEUPDATEREQUEST']._serialized_end=2892
  _globals['_PAYMENTSERVICEUPDATERESPONSE']._serialized_start=2894
  _globals['_PAYMENTSERVICEUPDATERESPONSE']._serialized_end=2977
  _globals['_PAYMENTSERVICEGETREQUEST']._serialized_start=2979
  _globals['_PAYMENTSERVICEGETREQUEST']._serialized_end=3039
  _globals['_PAYMENTSERVICEGETRESPONSE']._serialized_start=3041
  _globals['_PAYMENTSERVICEGETRESPONSE']._serialized_end=3121
  _globals['_PAYMENTSERVICEHASPAYMENTMETHODREQUEST']._serialized_start=3123
  _globals['_PAYMENTSERVICEHASPAYMENTMETHODREQUEST']._serialized_end=3196
  _globals['_PAYMENTSERVICEHASPAYMENTMETHODRESPONSE']._serialized_start=3198
  _globals['_PAYMENTSERVICEHASPAYMENTMETHODRESPONSE']._serialized_end=3324
  _globals['_PAYMENTSERVICEDELETEREQUEST']._serialized_start=3326
  _globals['_PAYMENTSERVICEDELETEREQUEST']._serialized_end=3389
  _globals['_PAYMENTSERVICEDELETERESPONSE']._serialized_start=3391
  _globals['_PAYMENTSERVICEDELETERESPONSE']._serialized_end=3421
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONUSAGEREQUEST']._serialized_start=3423
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONUSAGEREQUEST']._serialized_end=3500
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONUSAGERESPONSE']._serialized_start=3503
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONUSAGERESPONSE']._serialized_end=3636
  _globals['_PAYMENTSERVICEGETINVOICESREQUEST']._serialized_start=3638
  _globals['_PAYMENTSERVICEGETINVOICESREQUEST']._serialized_end=3749
  _globals['_PAYMENTSERVICEGETINVOICESRESPONSE']._serialized_start=3751
  _globals['_PAYMENTSERVICEGETINVOICESRESPONSE']._serialized_end=3831
  _globals['_PAYMENTSERVICEGETDEFAULTPRICESREQUEST']._serialized_start=3833
  _globals['_PAYMENTSERVICEGETDEFAULTPRICESREQUEST']._serialized_end=3872
  _globals['_PAYMENTSERVICEGETDEFAULTPRICESRESPONSE']._serialized_start=3874
  _globals['_PAYMENTSERVICEGETDEFAULTPRICESRESPONSE']._serialized_end=3953
  _globals['_PAYMENTSERVICEHASCHARGEABLERESOURCESREQUEST']._serialized_start=3955
  _globals['_PAYMENTSERVICEHASCHARGEABLERESOURCESREQUEST']._serialized_end=4034
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONDISCOUNTSREQUEST']._serialized_start=4036
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONDISCOUNTSREQUEST']._serialized_end=4117
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONDISCOUNTSRESPONSE']._serialized_start=4119
  _globals['_PAYMENTSERVICEGETSUBSCRIPTIONDISCOUNTSRESPONSE']._serialized_end=4215
  _globals['_PAYMENTSERVICE']._serialized_start=4553
  _globals['_PAYMENTSERVICE']._serialized_end=5587
