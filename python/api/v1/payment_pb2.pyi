...
class Price(_message.Message):
    __slots__ = ("name", "unit_amount_decimal", "currency", "unit_label", "product_type", "description")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    description: str
    def __init__(self, name: _Optional[str] = ..., unit_amount_decimal: _Optional[float] = ..., currency: _Optional[str] = ..., unit_label: _Optional[str] = ..., product_type: _Optional[_Union[ProductType, str]] = ..., description: _Optional[str] = ...) -> None: ...
...
class SubscriptionUsageItem(_message.Message):
    ...
    def __init__(self, subscription_item_id: _Optional[str] = ..., subscription_item_name: _Optional[str] = ..., total_usage: _Optional[int] = ..., period_start: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., period_end: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class Invoice(_message.Message):
    ...
    period_start: _timestamp_pb2.Timestamp
    period_end: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[str] = ..., pdf_download_url: _Optional[str] = ..., period_start: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., period_end: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class PaymentServiceCreateOrUpdateCustomerRequest(_message.Message):
    ...
    def __init__(self, login: _Optional[str] = ..., customer: _Optional[_Union[PaymentCustomer, _Mapping]] = ..., accepted_terms_and_conditions: bool = ...) -> None: ...
...
class PaymentServiceGetCustomerWithLoginRequest(_message.Message):
    __slots__ = ("login",)
    LOGIN_FIELD_NUMBER: _ClassVar[int]
    login: str
    def __init__(self, login: _Optional[str] = ...) -> None: ...

class PaymentServiceGetCustomerWithLoginResponse(_message.Message):
    __slots__ = ("customer",)
    CUSTOMER_FIELD_NUMBER: _ClassVar[int]
    customer: PaymentCustomer
    def __init__(self, customer: _Optional[_Union[PaymentCustomer, _Mapping]] = ...) -> None: ...
...
class PaymentServiceHasPaymentMethodRequest(_message.Message):
    __slots__ = ("login", "project")
    LOGIN_FIELD_NUMBER: _ClassVar[int]
    PROJECT_FIELD_NUMBER: _ClassVar[int]
    login: str
    project: str
    def __init__(self, login: _Optional[str] = ..., project: _Optional[str] = ...) -> None: ...
...
class PaymentServiceCheckAdmittedRequest(_message.Message):
    __slots__ = ("login",)
    LOGIN_FIELD_NUMBER: _ClassVar[int]
    login: str
    def __init__(self, login: _Optional[str] = ...) -> None: ...

class PaymentServiceCheckAdmittedResponse(_message.Message):
    __slots__ = ("admitted", "requested")
    ADMITTED_FIELD_NUMBER: _ClassVar[int]
    REQUESTED_FIELD_NUMBER: _ClassVar[int]
    admitted: bool
    requested: bool
    def __init__(self, admitted: bool = ..., requested: bool = ...) -> None: ...

class PaymentServiceRequestAdmissionRequest(_message.Message):
    __slots__ = ("login", "customer", "accepted_terms_and_conditions", "email_consent")
    LOGIN_FIELD_NUMBER: _ClassVar[int]
    CUSTOMER_FIELD_NUMBER: _ClassVar[int]
    ACCEPTED_TERMS_AND_CONDITIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    accepted_terms_and_conditions: bool
    email_consent: bool
    def __init__(self, login: _Optional[str] = ..., customer: _Optional[_Union[PaymentCustomer, _Mapping]] = ..., accepted_terms_and_conditions: bool = ..., email_consent: bool = ...) -> None: ...

class PaymentServiceRequestAdmissionResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
