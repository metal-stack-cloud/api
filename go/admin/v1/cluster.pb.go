...
const file_admin_v1_cluster_proto_rawDesc = "" +
	...
	"\x13GetViewerKubeconfig\x122.admin.v1.ClusterServiceGetViewerKubeconfigRequest\x1a3.admin.v1.ClusterServiceGetViewerKubeconfigResponse\"\x06\xd2\xf3\x18\x02\x01\x02B\x93\x01\n" +
...
var file_admin_v1_cluster_proto_goTypes = []any{
	...
	(*ClusterServiceGetAdminKubeconfigResponse)(nil),  // 8: admin.v1.ClusterServiceGetAdminKubeconfigResponse
	(*ClusterServiceGetViewerKubeconfigResponse)(nil), // 9: admin.v1.ClusterServiceGetViewerKubeconfigResponse
	(*SSHKeyPair)(nil),                                // 10: admin.v1.SSHKeyPair
...
var file_admin_v1_cluster_proto_depIdxs = []int32{
	...
	12, // 1: admin.v1.ClusterServiceCredentialsRequest.expiration:type_name -> google.protobuf.Duration
	12, // 2: admin.v1.ClusterServiceGetAdminKubeconfigRequest.expiration:type_name -> google.protobuf.Duration
	12, // 3: admin.v1.ClusterServiceGetViewerKubeconfigRequest.expiration:type_name -> google.protobuf.Duration
	13, // 4: admin.v1.ClusterServiceGetResponse.cluster:type_name -> api.v1.Cluster
	14, // 5: admin.v1.ClusterServiceGetResponse.machines:type_name -> admin.v1.Machine
	13, // 6: admin.v1.ClusterServiceListResponse.clusters:type_name -> api.v1.Cluster
	10, // 7: admin.v1.ClusterServiceCredentialsResponse.ssh_keypair:type_name -> admin.v1.SSHKeyPair
	15, // 8: admin.v1.ClusterServiceCredentialsResponse.vpn:type_name -> admin.v1.VPN
	0,  // 9: admin.v1.ClusterService.Get:input_type -> admin.v1.ClusterServiceGetRequest
	1,  // 10: admin.v1.ClusterService.List:input_type -> admin.v1.ClusterServiceListRequest
	2,  // 11: admin.v1.ClusterService.Credentials:input_type -> admin.v1.ClusterServiceCredentialsRequest
	3,  // 12: admin.v1.ClusterService.GetAdminKubeconfig:input_type -> admin.v1.ClusterServiceGetAdminKubeconfigRequest
	4,  // 13: admin.v1.ClusterService.GetViewerKubeconfig:input_type -> admin.v1.ClusterServiceGetViewerKubeconfigRequest
	5,  // 14: admin.v1.ClusterService.Get:output_type -> admin.v1.ClusterServiceGetResponse
	6,  // 15: admin.v1.ClusterService.List:output_type -> admin.v1.ClusterServiceListResponse
	7,  // 16: admin.v1.ClusterService.Credentials:output_type -> admin.v1.ClusterServiceCredentialsResponse
	8,  // 17: admin.v1.ClusterService.GetAdminKubeconfig:output_type -> admin.v1.ClusterServiceGetAdminKubeconfigResponse
	9,  // 18: admin.v1.ClusterService.GetViewerKubeconfig:output_type -> admin.v1.ClusterServiceGetViewerKubeconfigResponse
