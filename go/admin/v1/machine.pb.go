...
func file_admin_v1_machine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_admin_v1_machine_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_admin_v1_machine_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_admin_v1_machine_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*VPN); i {
			case 0:
				return &v.state
			case 1:
