...
func GetServicePermissions() *ServicePermissions {
	return &ServicePermissions{
		Roles: Roles{
			...
			Project: Project{
				"PROJECT_ROLE_EDITOR": []string{
					...
					"/api.v1.MachineService/Create",
					"/api.v1.MachineService/Get",
					"/api.v1.MachineService/List",
					"/api.v1.MachineService/Delete",
		...
		Methods: map[string]bool{
			...
			"/api.v1.MachineService/Create":                 true,
			"/api.v1.MachineService/Delete":                 true,
			"/api.v1.MachineService/Get":                    true,
			"/api.v1.MachineService/List":                   true,
		...
		Auditable: map[string]bool{
			...
			"/api.v1.MachineService/Create":                 true,
			"/api.v1.MachineService/Delete":                 true,
			"/api.v1.MachineService/Get":                    false,
			"/api.v1.MachineService/List":                   false,
			"/api.v1.MethodService/List":                    true,
			"/api.v1.MethodService/TokenScopedList":         true,
