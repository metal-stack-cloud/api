...
func GetServicePermissions() *ServicePermissions {
	return &ServicePermissions{
		...
		Methods: map[string]bool{
			...
			"/api.v1.PaymentService/Create":                   true,
			"/api.v1.PaymentService/Delete":                   true,
			"/api.v1.PaymentService/Get":                      true,
			...
			"/api.v1.PaymentService/Update":                   true,
		...
		Auditable: map[string]bool{
			...
			"/api.v1.PaymentService/Create":                   true,
			"/api.v1.PaymentService/Delete":                   true,
			"/api.v1.PaymentService/Get":                      false,
