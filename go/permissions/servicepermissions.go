...
func GetServicePermissions() *ServicePermissions {
	return &ServicePermissions{
		...
		Methods: map[string]bool{
			...
			"/admin.v1.ClusterService/GetAdminKubeconfig":       true,
			"/admin.v1.ClusterService/GetMonitoringCredentials": true,
			"/admin.v1.ClusterService/GetViewerKubeconfig":      true,
			...
			"/api.v1.ClusterService/GetAdminKubeconfig":         true,
			"/api.v1.ClusterService/GetCredentials":             true,
			"/api.v1.ClusterService/GetMonitoringCredentials":   true,
			"/api.v1.ClusterService/GetViewerKubeconfig":        true,
			...
			"/api.v1.PaymentService/GetSubscriptionDiscounts":   true,
			...
			"/api.v1.TenantService/RequestAdmission":            true,
		...
		Auditable: map[string]bool{
			...
			"/admin.v1.ClusterService/GetAdminKubeconfig":       true,
			"/admin.v1.ClusterService/GetMonitoringCredentials": false,
			"/admin.v1.ClusterService/GetViewerKubeconfig":      true,
			"/admin.v1.ClusterService/List":                     false,
			"/admin.v1.PaymentService/AddBalanceToCustomer":     true,
			"/admin.v1.ProjectService/List":                     false,
			"/admin.v1.StorageService/ClusterInfo":              false,
			"/admin.v1.StorageService/ListSnapshots":            false,
			"/admin.v1.StorageService/ListVolumes":              false,
			"/admin.v1.TenantService/AddMember":                 true,
			"/admin.v1.TenantService/Admit":                     true,
			"/admin.v1.TenantService/List":                      false,
			"/admin.v1.TenantService/Revoke":                    true,
			"/admin.v1.TokenService/List":                       true,
			"/admin.v1.TokenService/Revoke":                     true,
			"/api.v1.AssetService/List":                         false,
			"/api.v1.AuditService/Get":                          false,
			"/api.v1.AuditService/List":                         false,
			"/api.v1.ClusterService/Create":                     true,
			"/api.v1.ClusterService/Delete":                     true,
			"/api.v1.ClusterService/Get":                        false,
			"/api.v1.ClusterService/GetAdminKubeconfig":         true,
			"/api.v1.ClusterService/GetCredentials":             true,
			"/api.v1.ClusterService/GetMonitoringCredentials":   false,
			"/api.v1.ClusterService/GetViewerKubeconfig":        true,
			...
			"/api.v1.PaymentService/GetSubscriptionDiscounts":   false,
			...
			"/api.v1.TenantService/RemoveMember":                true,
			"/api.v1.TenantService/RequestAdmission":            false,
			"/api.v1.TenantService/Update":                      true,
			"/api.v1.TenantService/UpdateMember":                true,
			"/api.v1.TokenService/Create":                       true,
			"/api.v1.TokenService/Get":                          true,
