...
func GetServicePermissions() *ServicePermissions {
	return &ServicePermissions{
		Roles: Roles{
			Admin: Admin{
				"ADMIN_ROLE_EDITOR": []string{
					...
					"/admin.v1.ProjectService/RemoveProject",
					...
					"/admin.v1.TenantService/RemoveMember",
					"/admin.v1.TenantService/RemoveTenant",
		...
		Methods: map[string]bool{
			...
			"/admin.v1.ProjectService/RemoveProject":        true,
			...
			"/admin.v1.TenantService/RemoveMember":          true,
			"/admin.v1.TenantService/RemoveTenant":          true,
