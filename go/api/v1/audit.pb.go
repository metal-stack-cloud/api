...
type AuditTrace struct {
	...
	ResultCode    int32 `protobuf:"varint,10,opt,name=result_code,json=resultCode,proto3" json:"result_code,omitempty"`
...
var file_api_v1_audit_proto_rawDesc = string([]byte{
	...
	0x63, 0x6f, 0x64, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x72, 0x65, 0x73, 0x75,
