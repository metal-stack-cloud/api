...
func (_e *TokenServiceHandler_Expecter) Create(context1 any, request any) *TokenServiceHandler_Create_Call {
...
func (_e *TokenServiceHandler_Expecter) Get(context1 any, request any) *TokenServiceHandler_Get_Call {
...
func (_e *TokenServiceHandler_Expecter) Update(context1 any, request any) *TokenServiceHandler_Update_Call {
