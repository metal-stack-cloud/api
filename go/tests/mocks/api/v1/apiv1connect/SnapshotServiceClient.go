...
type mockConstructorTestingTNewSnapshotServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSnapshotServiceClient(t mockConstructorTestingTNewSnapshotServiceClient) *SnapshotServiceClient {
