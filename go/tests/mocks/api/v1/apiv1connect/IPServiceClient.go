...
func (_m *IPServiceClient) Static(_a0 context.Context, _a1 *connect.Request[apiv1.IPServiceStaticRequest]) (*connect.Response[apiv1.IPServiceStaticResponse], error) {
	ret := _m.Called(_a0, _a1)
