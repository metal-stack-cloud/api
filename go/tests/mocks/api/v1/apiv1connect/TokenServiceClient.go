...
type mockConstructorTestingTNewTokenServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTokenServiceClient(t mockConstructorTestingTNewTokenServiceClient) *TokenServiceClient {
