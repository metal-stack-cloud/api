...
func (_m *ProjectServiceHandler) InviteRefresh(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectServiceInviteRefreshRequest]) (*connect.Response[apiv1.ProjectServiceInviteRefreshResponse], error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *ProjectServiceHandler) ListInvites(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectServiceListInvitesRequest]) (*connect.Response[apiv1.ProjectServiceListInvitesResponse], error) {
	ret := _m.Called(_a0, _a1)
