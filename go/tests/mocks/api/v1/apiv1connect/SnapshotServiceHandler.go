...
func (_e *SnapshotServiceHandler_Expecter) Delete(context1 any, request any) *SnapshotServiceHandler_Delete_Call {
...
func (_e *SnapshotServiceHandler_Expecter) Get(context1 any, request any) *SnapshotServiceHandler_Get_Call {
...
func (_e *SnapshotServiceHandler_Expecter) List(context1 any, request any) *SnapshotServiceHandler_List_Call {
