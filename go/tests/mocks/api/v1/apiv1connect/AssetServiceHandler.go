...
type mockConstructorTestingTNewAssetServiceHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAssetServiceHandler(t mockConstructorTestingTNewAssetServiceHandler) *AssetServiceHandler {
