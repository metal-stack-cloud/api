...
type mockConstructorTestingTNewAssetServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAssetServiceClient(t mockConstructorTestingTNewAssetServiceClient) *AssetServiceClient {
