...
func (_m *VolumeServiceHandler) Update(_a0 context.Context, _a1 *connect.Request[apiv1.VolumeServiceUpdateRequest]) (*connect.Response[apiv1.VolumeServiceUpdateResponse], error) {
	ret := _m.Called(_a0, _a1)
