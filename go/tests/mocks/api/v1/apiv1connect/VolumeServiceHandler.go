...
type mockConstructorTestingTNewVolumeServiceHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewVolumeServiceHandler(t mockConstructorTestingTNewVolumeServiceHandler) *VolumeServiceHandler {
