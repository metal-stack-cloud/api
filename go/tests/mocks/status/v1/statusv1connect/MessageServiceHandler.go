...
type mockConstructorTestingTNewMessageServiceHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMessageServiceHandler(t mockConstructorTestingTNewMessageServiceHandler) *MessageServiceHandler {
