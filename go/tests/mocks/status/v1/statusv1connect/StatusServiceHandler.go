...
type mockConstructorTestingTNewStatusServiceHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewStatusServiceHandler(t mockConstructorTestingTNewStatusServiceHandler) *StatusServiceHandler {
