...
type mockConstructorTestingTNewMessageServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMessageServiceClient(t mockConstructorTestingTNewMessageServiceClient) *MessageServiceClient {
