...
func (_m *ProjectServiceClient) RemoveProject(_a0 context.Context, _a1 *connect.Request[adminv1.ProjectServiceRemoveProjectRequest]) (*connect.Response[adminv1.ProjectServiceRemoveProjectResponse], error) {
	ret := _m.Called(_a0, _a1)
