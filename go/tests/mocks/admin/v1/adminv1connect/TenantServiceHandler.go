...
func (_m *TenantServiceHandler) DeleteTestUser(_a0 context.Context, _a1 *connect.Request[adminv1.TenantServiceDeleteTestUserRequest]) (*connect.Response[adminv1.TenantServiceDeleteTestUserResponse], error) {
	ret := _m.Called(_a0, _a1)
