...
func (_m *TenantServiceHandler) RemoveMember(_a0 context.Context, _a1 *connect.Request[adminv1.TenantServiceRemoveMemberRequest]) (*connect.Response[adminv1.TenantServiceRemoveMemberResponse], error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *TenantServiceHandler) RemoveTenant(_a0 context.Context, _a1 *connect.Request[adminv1.TenantServiceRemoveTenantRequest]) (*connect.Response[adminv1.TenantServiceRemoveTenantResponse], error) {
	ret := _m.Called(_a0, _a1)
