...
func (_m *ClusterServiceClient) Logs(_a0 context.Context, _a1 *connect.Request[adminv1.ClusterServiceLogsRequest]) (*connect.Response[adminv1.ClusterServiceLogsResponse], error) {
	ret := _m.Called(_a0, _a1)
