...
func (_m *PaymentServiceClient) DeleteTestUser(_a0 context.Context, _a1 *connect.Request[adminv1.PaymentServiceDeleteTestUserRequest]) (*connect.Response[adminv1.PaymentServiceDeleteTestUserResponse], error) {
	ret := _m.Called(_a0, _a1)
