...
func (_m *MethodServiceClient) List(_a0 context.Context, _a1 *connect.Request[adminv1.MethodServiceListRequest]) (*connect.Response[adminv1.MethodServiceListResponse], error) {
