...
func (_m *PaymentServiceHandler) DeleteTestUser(_a0 context.Context, _a1 *connect.Request[adminv1.PaymentServiceDeleteTestUserRequest]) (*connect.Response[adminv1.PaymentServiceDeleteTestUserResponse], error) {
	ret := _m.Called(_a0, _a1)

	var r0 *connect.Response[adminv1.PaymentServiceDeleteTestUserResponse]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[adminv1.PaymentServiceDeleteTestUserRequest]) (*connect.Response[adminv1.PaymentServiceDeleteTestUserResponse], error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[adminv1.PaymentServiceDeleteTestUserRequest]) *connect.Response[adminv1.PaymentServiceDeleteTestUserResponse]); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*connect.Response[adminv1.PaymentServiceDeleteTestUserResponse])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *connect.Request[adminv1.PaymentServiceDeleteTestUserRequest]) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
