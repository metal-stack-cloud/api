...
func (_m *TenantServiceClient) AddBalance(_a0 context.Context, _a1 *connect.Request[adminv1.TenantServiceAddBalanceRequest]) (*connect.Response[adminv1.TenantServiceAddBalanceResponse], error) {
