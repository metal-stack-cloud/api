...
func (_m *TenantServiceClient) Block(_a0 context.Context, _a1 *connect.Request[adminv1.TenantServiceBlockRequest]) (*connect.Response[adminv1.TenantServiceBlockResponse], error) {
	ret := _m.Called(_a0, _a1)
