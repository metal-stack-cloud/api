...
func (_e *ClusterServiceHandler_Expecter) Credentials(context1 any, request any) *ClusterServiceHandler_Credentials_Call {
...
func (_c *ClusterServiceHandler_GetMonitoringCredentials_Call) Run(run func(context1 context.Context, request *connect.Request[adminv1.ClusterServiceGetMonitoringCredentialsRequest])) *ClusterServiceHandler_GetMonitoringCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ClusterServiceHandler_GetMonitoringCredentials_Call) Return(response *connect.Response[adminv1.ClusterServiceGetMonitoringCredentialsResponse], err error) *ClusterServiceHandler_GetMonitoringCredentials_Call {
	_c.Call.Return(response, err)
	return _c
}
