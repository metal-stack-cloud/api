...
type mockConstructorTestingTNewStorageServiceHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewStorageServiceHandler(t mockConstructorTestingTNewStorageServiceHandler) *StorageServiceHandler {
