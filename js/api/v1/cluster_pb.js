...
Cluster.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 23, name: "api_server_acl", kind: "message", T: APIServerACL },
]);
/**
 ...
 */
class APIServerACL extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static fromJson(jsonValue, options) {
        return new APIServerACL().fromJson(jsonValue, options);
    }
    static fromJsonString(jsonString, options) {
        return new APIServerACL().fromJsonString(jsonString, options);
    }
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(APIServerACL, a, b);
    }
}
exports.APIServerACL = APIServerACL;
APIServerACL.runtime = protobuf_1.proto3;
APIServerACL.typeName = "api.v1.APIServerACL";
APIServerACL.fields = protobuf_1.proto3.util.newFieldList(() => [
...
ClusterServiceUpdateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 23, name: "api_server_acl", kind: "message", T: APIServerACL, opt: true },
]);
/**
