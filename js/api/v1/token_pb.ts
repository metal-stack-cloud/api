 ...
 */
export class TokenServiceGetRequest extends Message<TokenServiceGetRequest> {
  /**
 ...
 */
export class TokenServiceGetResponse extends Message<TokenServiceGetResponse> {
  /**
   * Token is the token
   *
   * @generated from field: api.v1.Token token = 1;
