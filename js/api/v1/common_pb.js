 ...
 */
export const tenant_roles = proto3.makeExtension("api.v1.tenant_roles", MethodOptions, () => ({ no: 51000, kind: "enum", T: proto3.getEnumType(TenantRole), repeated: true }));
/**
 ...
 */
export const project_roles = proto3.makeExtension("api.v1.project_roles", MethodOptions, () => ({ no: 51001, kind: "enum", T: proto3.getEnumType(ProjectRole), repeated: true }));
/**
 ...
 */
export const admin_roles = proto3.makeExtension("api.v1.admin_roles", MethodOptions, () => ({ no: 51002, kind: "enum", T: proto3.getEnumType(AdminRole), repeated: true }));
/**
 ...
 */
export const visibility = proto3.makeExtension("api.v1.visibility", MethodOptions, () => ({ no: 51003, kind: "enum", T: proto3.getEnumType(Visibility) }));
/**
 ...
 */
export const chargeable = proto3.makeExtension("api.v1.chargeable", MethodOptions, () => ({ no: 51004, kind: "enum", T: proto3.getEnumType(Chargeable) }));
/**
 * Auditing defines if calls to this method should be audited or not
 *
 * @generated from extension: api.v1.Auditing auditing = 51005;
 */
export const auditing = proto3.makeExtension("api.v1.auditing", MethodOptions, () => ({ no: 51005, kind: "enum", T: proto3.getEnumType(Auditing) }));
