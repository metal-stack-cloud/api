...
proto.api.v1.Health = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1.Health.repeatedFields_, null);
};
 ...
 * @const
 */
proto.api.v1.Health.repeatedFields_ = [1];
 ...
 */
proto.api.v1.Health.prototype.getServicesList = function() {
...
*/
proto.api.v1.Health.prototype.setServicesList = function(value) {
 ...
 */
proto.api.v1.Health.prototype.addServices = function(opt_value, opt_index) {
 ...
 * @return {!proto.api.v1.Health} returns this
 */
proto.api.v1.Health.prototype.clearServicesList = function() {
...
proto.api.v1.HealthStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    partitionsMap: (f = msg.getPartitionsMap()) ? f.toObject(includeInstance, proto.api.v1.PartitionHealth.toObject) : []
  };
...
proto.api.v1.HealthStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(4, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.api.v1.PartitionHealth.serializeBinaryToWriter);
  }
};
 ...
 */
proto.api.v1.HealthStatus.prototype.getPartitionsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.api.v1.HealthStatus} returns this
 */
proto.api.v1.HealthStatus.prototype.clearPartitionsMap = function() {
 ...
 * @return {!proto.api.v1.ServiceStatus}
 */
proto.api.v1.PartitionHealth.prototype.getStatus = function() {
  return /** @type {!proto.api.v1.ServiceStatus} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.api.v1.PartitionHealth.prototype.setStatus = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.v1.PartitionHealth.prototype.getMessage = function() {
 ...
 * @return {!proto.api.v1.PartitionHealth} returns this
 */
proto.api.v1.PartitionHealth.prototype.setMessage = function(value) {
