 ...
 */
export class IP extends Message {
    constructor(data) {
        super();
        /**
         * Uuid of this ip
...
IP.fields = proto3.util.newFieldList(() => [
 ...
 */
export class IPServiceGetRequest extends Message {
    constructor(data) {
        super();
        /**
...
IPServiceGetRequest.runtime = proto3;
IPServiceGetRequest.typeName = "api.v1.IPServiceGetRequest";
IPServiceGetRequest.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export class IPServiceAllocateRequest extends Message {
    constructor(data) {
        super();
        /**
         * Project of the ip
...
IPServiceAllocateRequest.runtime = proto3;
IPServiceAllocateRequest.typeName = "api.v1.IPServiceAllocateRequest";
IPServiceAllocateRequest.fields = proto3.util.newFieldList(() => [
    { no: 2, name: "project", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 8, name: "tags", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
 ...
 */
export class IPServiceUpdateRequest extends Message {
    constructor(data) {
        super();
        /**
         * Project of the ip
...
IPServiceUpdateRequest.runtime = proto3;
IPServiceUpdateRequest.typeName = "api.v1.IPServiceUpdateRequest";
IPServiceUpdateRequest.fields = proto3.util.newFieldList(() => [
 ...
 */
export class IPServiceListRequest extends Message {
    constructor(data) {
        super();
        /**
...
IPServiceListRequest.runtime = proto3;
IPServiceListRequest.typeName = "api.v1.IPServiceListRequest";
IPServiceListRequest.fields = proto3.util.newFieldList(() => [
    { no: 2, name: "project", kind: "scalar", T: 9 /* ScalarType.STRING */ },
]);
/**
 ...
 */
export class IPServiceDeleteRequest extends Message {
    constructor(data) {
        super();
        /**
...
IPServiceDeleteRequest.runtime = proto3;
IPServiceDeleteRequest.typeName = "api.v1.IPServiceDeleteRequest";
IPServiceDeleteRequest.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "project", kind: "scalar", T: 9 /* ScalarType.STRING */ },
]);
/**
 ...
 */
export class IPServiceGetResponse extends Message {
    constructor(data) {
        super();
        proto3.util.initPartial(data, this);
    }
...
IPServiceGetResponse.runtime = proto3;
IPServiceGetResponse.typeName = "api.v1.IPServiceGetResponse";
IPServiceGetResponse.fields = proto3.util.newFieldList(() => [
 ...
 */
export class IPServiceUpdateResponse extends Message {
    constructor(data) {
        super();
        proto3.util.initPartial(data, this);
    }
...
IPServiceUpdateResponse.runtime = proto3;
IPServiceUpdateResponse.typeName = "api.v1.IPServiceUpdateResponse";
IPServiceUpdateResponse.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "ip", kind: "message", T: IP },
]);
/**
 ...
 */
export class IPServiceAllocateResponse extends Message {
    constructor(data) {
        super();
        proto3.util.initPartial(data, this);
    }
...
IPServiceAllocateResponse.runtime = proto3;
IPServiceAllocateResponse.typeName = "api.v1.IPServiceAllocateResponse";
IPServiceAllocateResponse.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "ip", kind: "message", T: IP },
]);
/**
 ...
 */
export class IPServiceListResponse extends Message {
    constructor(data) {
        super();
        /**
         * Ips the ips
...
IPServiceListResponse.runtime = proto3;
IPServiceListResponse.typeName = "api.v1.IPServiceListResponse";
IPServiceListResponse.fields = proto3.util.newFieldList(() => [
 ...
 */
export class IPServiceDeleteResponse extends Message {
    constructor(data) {
        super();
        proto3.util.initPartial(data, this);
    }
...
IPServiceDeleteResponse.runtime = proto3;
IPServiceDeleteResponse.typeName = "api.v1.IPServiceDeleteResponse";
IPServiceDeleteResponse.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "ip", kind: "message", T: IP },
]);
