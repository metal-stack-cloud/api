 ...
 */
export class MessageServiceListRequest extends Message$1 {
    constructor(data) {
        super();
...
MessageServiceListRequest.runtime = proto3;
 ...
 */
export class MessageServiceListResponse extends Message$1 {
    constructor(data) {
        super();
        /**
...
Message.runtime = proto3;
Message.typeName = "status.v1.Message";
Message.fields = proto3.util.newFieldList(() => [
 ...
 */
export class ReplyMessage extends Message$1 {
    constructor(data) {
        super();
        /**
         * Id of the message
...
ReplyMessage.runtime = proto3;
ReplyMessage.typeName = "status.v1.ReplyMessage";
ReplyMessage.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "text", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "kind", kind: "enum", T: proto3.getEnumType(MessageKind) },
    { no: 4, name: "timestamp", kind: "message", T: Timestamp },
