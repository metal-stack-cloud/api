 ...
 */
export class TenantServiceRemoveTenantRequest extends Message<TenantServiceRemoveTenantRequest> {
  /**
 ...
 */
export class TenantServiceRemoveTenantResponse extends Message<TenantServiceRemoveTenantResponse> {
  /**
   * Confirmation of the removal
   *
   * @generated from field: bool success = 1;
