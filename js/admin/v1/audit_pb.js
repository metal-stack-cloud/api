 ...
 */
export const AuditServiceGetRequestSchema = /*@__PURE__*/ messageDesc(file_admin_v1_audit, 2);
/**
 * Describes the message admin.v1.AuditServiceGetResponse.
 * Use `create(AuditServiceGetResponseSchema)` to create a new message.
 */
export const AuditServiceGetResponseSchema = /*@__PURE__*/ messageDesc(file_admin_v1_audit, 3);
/**
