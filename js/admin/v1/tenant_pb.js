...
TenantServiceRemoveMemberRequest.typeName = "admin.v1.TenantServiceRemoveMemberRequest";
 ...
 */
export class TenantServiceRemoveTenantRequest extends Message {
    constructor(data) {
        super();
        /**
    ...
    static fromBinary(bytes, options) {
        return new TenantServiceRemoveTenantRequest().fromBinary(bytes, options);
    }
    static fromJson(jsonValue, options) {
        return new TenantServiceRemoveTenantRequest().fromJson(jsonValue, options);
    }
    static fromJsonString(jsonString, options) {
        return new TenantServiceRemoveTenantRequest().fromJsonString(jsonString, options);
    }
    static equals(a, b) {
        return proto3.util.equals(TenantServiceRemoveTenantRequest, a, b);
    }
}
TenantServiceRemoveTenantRequest.runtime = proto3;
TenantServiceRemoveTenantRequest.typeName = "admin.v1.TenantServiceRemoveTenantRequest";
TenantServiceRemoveTenantRequest.fields = proto3.util.newFieldList(() => [
    { no: 1, name: "tenant_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
]);
/**
 ...
 */
export class TenantServiceRemoveTenantResponse extends Message {
    constructor(data) {
        super();
        /**
         * Confirmation of the removal
    ...
    static fromBinary(bytes, options) {
        return new TenantServiceRemoveTenantResponse().fromBinary(bytes, options);
    }
    static fromJson(jsonValue, options) {
        return new TenantServiceRemoveTenantResponse().fromJson(jsonValue, options);
    }
    static fromJsonString(jsonString, options) {
        return new TenantServiceRemoveTenantResponse().fromJsonString(jsonString, options);
    }
    static equals(a, b) {
        return proto3.util.equals(TenantServiceRemoveTenantResponse, a, b);
    }
}
TenantServiceRemoveTenantResponse.runtime = proto3;
